 ...
 * @Last Modified time: 2018-12-20 16:01:31
 */
...
export function getVehicleIdAndChangeStatusDialog(vehicleId, status) {
  return {
    type: actionTypes.GET_VEHICLE_ID_AND_CHANGE_STATUS_DIALOG,
