 ...
 * @Last Modified time: 2018-12-27 14:30:27
 */
...
export class FormInfo extends React.PureComponent {
  ...
  componentDidUpdate(prevProps) {
    ...
    const ID = qs.parse(location.search)['?id'] || '';
    if (
      !_isEqual(prevProps.VehicleManagement.rowInfo, VehicleManagement.rowInfo)
    ) {
...
FormInfo.propTypes = {
  ...
  getVehicleIdAndChangeStatusDialog: PropTypes.func.isRequired,
};
